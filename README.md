...
* Un ordinateur avec
	...
	* Mon interface graphique disponible sur ce repo, ou Node.js configuré avec Electron et serialPort ( exemple de base [ici](https://github.com/johnny-five-io/electron-serialport)) si vous souhaitez faire la votre
...
Le code à téléverser dans la carte est disponible également sur ce repo à [cet endroit](???).
# Description du projet
